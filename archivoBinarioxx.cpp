...
int Persona::creaFile( ofstream & salida, Persona *r, int N){
    int  i=0,b;
      ...
      do{
       ...
       fflush(stdin);
       salida.seekp(sizeof(Persona), ios::beg); //el apuntador de archivo se coloca al inicio del archivo; a partir de ahí escribe registros
...
void Persona::listaFile(ifstream & entrada, Persona *r){
    ...
    do{
        entrada.seekg(sizeof(Persona), ios::end);   //el apuntador de archivo se coloca en el ultimo registro y este es el que despliega
